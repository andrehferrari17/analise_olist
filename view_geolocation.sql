CREATE OR REPLACE VIEW vw_distancia_vendedor_cliente_score AS
...
SELECT DISTINCT ON (o.order_id)
    ...
    o.order_estimated_delivery_date AS "Data Estimada",
    o.order_delivered_customer_date AS "Data de entrega",
    o.order_delivered_customer_date - o.order_estimated_delivery_date AS "Tempo de entrega",
    oi.price AS "Preço",
